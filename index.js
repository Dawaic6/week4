...
output.textContent = "It's your time to play "
...
function playRound(){
    ...
    if (result == 0){
    output.textContent = `It's draw , You chose ${playerChoice} and The computer chose ${compChoice.Value}`;
    }
    else if (result == 1){
    output.textContent = `You win ,You chose ${playerChoice} and The computer chose ${compChoice.Value}`;
    playerScore++;
...
function playGame(){
        ...
        computer.textContent = `Computer Score: ${compScore}`;
        if (playerScore == 5){
            output.textContent = "You Won the Game   WOWO  WOWO  WOWO     Congratillation";
            playerScore = 0;
            compScore = 0;
            player.textContent = `Player Score: ${playerScore}`;
            computer.textContent = `Computer Score: ${compScore}`;
